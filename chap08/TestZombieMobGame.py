...
start_seconds = int(pygame.time.get_ticks()) / 1000
...
while True:
    ...
    current_seconds = int(ticks) / 1000
    ...
    if not game_over:
        ...
        for z in zombie_group:
            attacker = None
            attacker = pygame.sprite.spritecollideany(z, zombie_group)     
            if attacker != None:
                
                if pygame.sprite.collide_rect_ratio(0.5)(z, attacker):
        ...
        for h in health_group:
            ...
            if player_health > 100:
                player_health = 100
                h.X = random.randint(0,700)
                h.Y = random.randint(0,500)
