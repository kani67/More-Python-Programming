...
class Food(MySprite):
    def __init__(self):
        ...
        pygame.draw.circle(self.image, (250,250,50), (16,16), 16, 0)
...
class SnakeSegment(MySprite):
    ...
    def __init__(self,color_new=(20,200,20)):
        MySprite.__init__(self)
        color1 = random.randint(0, 100)
        color2 = random.randint(50, 255)
        color3 = random.randint(0, 150)
        
        color_new = (color1 ,color2, color3)
        
        image = pygame.Surface((32,32)).convert_alpha()
        
        
        image.fill((color1, color2, color3, 0))
        
        pygame.draw.circle(image, color_new, (16,16), 16, 0)
