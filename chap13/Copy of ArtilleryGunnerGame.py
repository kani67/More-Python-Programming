...
computer_crater_x = 0
computer_crater_y = 0
computer_hit_terrain = False

player_crater_x = 0
playter_crater_y = 0
player_hit_terrain = False
...
while True:
    ...
    if not game_over:
        ...
        if player_firing:
            ...
            if player_shell_position.y > height:
                player_crater_y = int(player_shell_position.y)
                player_crater_x = int(player_shell_position.x)   
                
                player_hit_terrain = True        
                player_firing = False
        ...
        if computer_firing:
            ...
            if computer_shell_position.y > height:
                computer_crater_y = int(computer_shell_position.y)
                computer_crater_x = int(computer_shell_position.x) 
            
                computer_hit_terrain = True
                computer_firing = False
    ...
    if player_hit_terrain:
        pygame.draw.circle(backbuffer, red, (player_crater_x, player_crater_y), 10, 0)
        
    
     
    if computer_hit_terrain:
        pygame.draw.circle(backbuffer, red, (computer_crater_x, computer_crater_y), 10, 0)
    ...
    if not game_over:
        ...
        if hit:
            print_text(font, 250, 200, "BOOM!" , red)
